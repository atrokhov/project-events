class PrimecategoriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @primecategory.save
        format.html { redirect_to @primecategory, notice: 'Primecategory was successfully created.' }
        format.json { render :show, status: :created, location: @primecategory }
      else
  ...
  def update
    respond_to do |format|
      if @primecategory.update(primecategory_params)
        format.html { redirect_to @primecategory, notice: 'Primecategory was successfully updated.' }
        format.json { render :show, status: :ok, location: @primecategory }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to primecategories_url, notice: 'Primecategory was successfully destroyed.' }
